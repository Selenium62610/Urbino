...
class Engine extends OpenXum.Engine {
    constructor(t, c) {
        ...
        this._selectedBuildingType=BuildingType.NONE;
    ...
    tests(){
        ...
        this.placeArchitect(this._architects[0], 0, 0);
        this.placeArchitect(this._architects[1], 1, 0);
        this.textBoardGivenCoordinates(this._architects[0].lineView());
...
*/
            ...
            case Phase.BUILDING:
               ...
               // if(_manager.enoughPiece(this._selectedBuildingType,this._color)) {
                   ...
                   // console.log("X:"+_item._x + " Y:"+_item._y);
                        ...
                        moves.push(new Move(_item.x(), _item.y(), new Building(this._color,this._selectedBuildingType,new Coordinates(_item.x(), _item.y()))));


                    }
                    this._color=this.next_color();
               //    }
    ...
    move(move) {
        ...
        console.log("le param de la methode move est  un Move ? ");
