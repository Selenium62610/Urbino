...
class Engine extends OpenXum.Engine {
    ...
    get_possible_move_list() {
        ...
        switch(this._phase) {
            case Phase.NONE:
                console.log("GET POSSIBLE MOVE LIST IN PHASE NONE => []");
            ...
            case Phase.BUILDING:
                ...
                console.log("afficher moves.length" +moves.length);
                if(moves.length===0) {

                    // this.nbPassed +=1;
                    console.log("MOVE LENGTH = 0 ON PUSH UN NEW MOVE -30 -30");
    ...
    move(move) {
        ...
        console.log("NBPASSE D?"+this.nbPassed);
        if(! (move instanceof Move)) {
            ...
            if (move._coord.x() === -30 && move._coord.y() === -30) {
              console.log(this._phase);
                console.log("plus de mouvement possible de building");
                ...
                console.log("phase none , set phase to ar");
                if(this.moved) {
                ...
                console.log("coord de pas bo qui bouge pas l'architect");
                this._phase = Phase.NONE;
                ...
                console.log("IN PHASE ARCHITECT");
                ...
                console.log("PHASE BUILDING WITH GOOD BUILDING");
                move._piece._coord._x = move._coord._x;
                move._piece._coord._y = move._coord._y;
