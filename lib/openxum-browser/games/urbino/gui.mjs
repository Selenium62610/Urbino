        ...
        if (this._engine._phase == Phase.BUILDING) {
           ...
           // console.log("phase Building and click");
            ...
            for(let i=0 ;i<liste_intersection.length; i++)
            {
                ...
                {
                    this._draw_piece(new Building(this._color, this._engine._selectedBuildingType, new Coordinates(x,y)))
                    this._engine.move(new Move(x,y, new Building(this._color, this._engine._selectedBuildingType, new Coordinates(x,y))));
                }
            }
            ...
            if (this._engine._phase === Phase.ARCHITECT ) {
                ...
                if(!this.moved) {
                    ...
                    for (let i = 0; i < liste_intersection.length; i++) {
                        if (liste_intersection[i]._coord.x() == x && liste_intersection[i]._coord.y() == y) {
                            console.log(this._engine._selectedArchitect);
                            console.log(this._engine._architects[this._engine._selectedArchitect]);
                            console.log("engine : ");
                            console.log(this._engine);
                            this._engine.move(new Move(x, y, this._engine._architects[this._engine._selectedArchitect]));
                            console.log('Déplacement architecte');
                            this.draw();
