...
class Gui extends OpenXum.Gui {
    ...
    draw() {
        ...
        this._context.fillStyle = "#e600d7";
       ...
       /* this._draw_piece(2,2, Architecte);
        this._draw_piece(9,9, Architecte);*/
...
Architecte() {
    ...
    _draw_piece(x,y,piece)
    {
       ...
       let radius = (this._deltaX / 5); // Créer un rond de taille
        ...
        {
            console.log("House");
            this._context.strokeStyle = "#e62b1c";
            this._context.fillStyle = "#f5110f";
        ...
        if(piece === BuildingType.PALACE)
        {
            ...
            this._context.moveTo(x,y+10);
            this._context.lineTo(x-15,y+10);
            this._context.lineTo(x-15,y-20);
            this._context.lineTo(x-10,y-20);
            this._context.lineTo(x-10,y-10);
